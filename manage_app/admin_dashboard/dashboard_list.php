<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-primary">ภาพรวมข้อมูลความพึงพอใจ</h1>
</div>
<div class="row">
    <!-- แย่มาก (Very Poor) -->
    <?php
    $sql_very_poor = " SELECT count(id) AS 'count_voter' FROM voter WHERE voter_rate = 'แย่มาก' ";
    ...
    <!-- แย่ (Poor) -->
    <?php
    $sql_poor = " SELECT count(id) AS 'count_voter' FROM voter WHERE voter_rate = 'แย่' ";
    ...
    <!-- พอใช้ (Average) -->
    <?php
    $sql_average = " SELECT count(id) AS 'count_voter' FROM voter WHERE voter_rate = 'พอใช้' ";
    ...
    <!-- ดี (Good) -->
    <?php
    $sql_good = " SELECT count(id) AS 'count_voter' FROM voter WHERE voter_rate = 'ดี' ";
    ...
    <!-- ดีมาก (Excellent) -->
    <?php
    $sql_excellent = " SELECT count(id) AS 'count_voter' FROM voter WHERE voter_rate = 'ดีมาก' ";
...
<?php
$sql_view = " SELECT * FROM assessor ";
$result_view = mysqli_query($conn, $sql_view);
while ($rs_view = mysqli_fetch_assoc($result_view)) {
    $id_view = $rs_view['id'];
?>
    <div class="card mb-3">
